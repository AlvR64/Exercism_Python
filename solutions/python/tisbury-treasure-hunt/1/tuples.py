...
def compare_records(azara_record, rui_record):
    ...
    return True if azara_record[-1] == "".join(rui_record[1]) else False
...
def clean_up(combined_record_group):
    ...
    for item, _, location, coordinates, color in combined_record_group:
        cleaned_record = (item, location, coordinates, color)

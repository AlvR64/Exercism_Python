...
def is_blackjack(card_one, card_two):
    ...
    value_one = value_of_card(card_one) if card_one != 'A' else 11
    value_two = value_of_card(card_two) if card_two != 'A' else 11

    return True if value_one + value_two == 21 else False

...
def fix_list_of_wagons(each_wagons_id, missing_wagons):
    ...
    """
    sorted_ids = each_wagons_id[2:] + each_wagons_id[:2]
    index_one = sorted_ids.index(1)

    sorted_ids[index_one + 1:index_one + 1] = missing_wagons
...
def add_missing_stops(route, **kwargs):
    ...
    route["stops"] = []
    for stop in kwargs:
        route["stops"].append(kwargs[stop])
